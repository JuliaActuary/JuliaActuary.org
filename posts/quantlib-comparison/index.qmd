...
| 30-pillar KRD — `duration(KeyRates(tenors), zrc, cfs)` / per-pillar `ZeroCurve` bumps          | ~9 μs (single AD pass)| ~1170 μs           | ~130×  |
