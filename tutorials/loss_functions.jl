...
# ╔═╡ 68b8b124-aa5e-4f57-8e51-ba642ac6ab96
penalty_abs(actual,estimated)  = abs(actual - estimated)

# ╔═╡ 6c2296e8-afb6-441f-84f3-49677edd4416
penalty_SE(actual,estimated)  = (actual - estimated)^2

# ╔═╡ 49a9b57a-417f-40c7-9836-3d6cc0812944
q_true = 0.025

# ╔═╡ 16f3aa71-aadc-4456-9a95-0aad30bd4eab
N = 100

# ╔═╡ 7f460d24-b659-4bb2-89f7-e3d3c133b856
simulated_claims = rand(N) .<  q_true # 

# ╔═╡ 29e0a291-523e-44d1-901e-972631bf6c66
sum(simulated_claims)

# ╔═╡ b5fdd411-3aeb-47f2-ada1-fee3fc1e0370
@model function model(claims,exposures)
	μ ~ Beta(1,1)
	claims ~ Binomial(exposures,μ)
end

# ╔═╡ 3344d526-35e4-40dc-931d-8542f3ba4032
...
manifest_format = "2.0"
project_hash = "a09a2051f8abfd210f04d377f9567163b35edbf8"
...
git-tree-sha1 = "e4c960f890c64ea9adbff9e4f020d8a9cdb155b3"
